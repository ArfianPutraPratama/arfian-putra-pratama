...
import { AppWindow, Database, Brain, Code2 } from "lucide-react"
...
const features = [
  ...
  },
  {
    ...
    description: "Creating intelligent agents and models",
    accent: "#FF6B35",
  },
  {
    icon: Database,
    ...
    description: "Transforming raw data into decisions",
    accent: "#00D4FF",
  },
  {
    icon: Code2,
...
export function BentoGrid() {
  ...
  return (
    <section id="skills" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#C4874A] text-[10px] tracking-[0.3em] uppercase"
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#C4874A] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
