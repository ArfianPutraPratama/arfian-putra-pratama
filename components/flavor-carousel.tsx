...
const flavors = [
  {
    id: 1,
    name: "Celerates",
    tagline: "Data Science & GenAI Intern",
    description: "Built end-to-end AI applications using Python, Machine Learning, Deep Learning, Streamlit, LangChain, RAG, and LLMs.",
    image: "/images/cele.png",
    bgColor: "from-[#A0714F]/20 via-[#A0714F]/10 to-transparent",
    accentColor: "#A0714F",
    badges: ["Python", "Data Science", "Generative AI", "LLMs"],
  },
  {
    id: 2,
    name: "PT Prima Visi Globalindo",
    tagline: "Mobile App Developer Intern",
    description: "Developed cross-platform mobile apps using Flutter for PDAM Surabaya and an E-Procurement system for Yayasan Salib Suci. Integrated RESTful APIs and optimized performance.",
    image: "/images/primavisi.png",
    bgColor: "from-[#f59e0b]/20 via-[#f59e0b]/10 to-transparent",
    accentColor: "#f59e0b",
    badges: ["Flutter", "Dart", "REST API"],
  },
  {
    id: 3,
    name: "VINIX7",
    tagline: "Data Analyst Intern",
    description: "Collected, cleaned, and analyzed datasets to generate actionable business insights.",
    image: "/images/vinix.png",
    bgColor: "from-[#00D4FF]/20 via-[#00D4FF]/10 to-transparent",
    accentColor: "#00D4FF",
    badges: ["Data Analysis", "Excel", "Statistics"],
  },
]
